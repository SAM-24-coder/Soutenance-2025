# Fonction pour afficher l'interface d'ajout d'utilisateur dans Active Directory
function Show-AddUserForm {
    ...
    # Assurez-vous que le formulaire prend en charge les événements
